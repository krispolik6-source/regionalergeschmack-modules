...
**Dzień:** 2026-08-03
**Wygenerowano:** 2026-08-03T19:06:35.293Z
**Etap:** 33D
...
**Odpowiedź:** tak
**Severity (problem):** 75 / 100 · confidence 72
...
- Health performance 85 (statyczny — nie neguje kosztu startu mapy)
...
**Odpowiedź:** tak
**Severity (problem):** 100 / 100 · confidence 65
...
- Health unusedJs count 16

## 3 najlepsze propozycje

### 1. Ukryj lub zwiń najniżej zaangażowane sekcje Home + usuń martwy Font Awesome z krytycznej ścieżki

- **ID:** `pi-hide-low-value-sections`
- **Pytanie:** unusedSection
- **Dlaczego:** Prawie nieużywane: tak (severity 100)
...
### 2. Ładuj Leaflet + MarkerCluster dopiero przy pierwszym wejściu na mapę

- **ID:** `pi-defer-leaflet`
- **Pytanie:** mapSlow
- **Dlaczego:** Mapa / cold start: tak (severity 75)
...
| Focus na jutro | Ukryj lub zwiń najniżej zaangażowane sekcje Home + usuń martwy Font Awesome z krytycznej ścieżki |
