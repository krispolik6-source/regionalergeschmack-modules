...
export const SYSTEM_HEALTH_I18N = Object.freeze({
    de: {
        ...
        colTime: 'Zeit',
        counts: '{fixed} behoben · {suggestion} Hinweise · {info} UI/UX · {failed} offen',
    ...
    en: {
        ...
        colTime: 'Time',
        counts: '{fixed} fixed · {suggestion} hints · {info} UI/UX · {failed} open',
        devTitle: 'System Health',
    ...
    pl: {
        ...
        colDescription: 'Opis',
        colTime: 'Czas',
        counts: '{fixed} napraw · {suggestion} sugestii · {info} UI/UX · {failed} otwartych',
        devTitle: 'System Health',
