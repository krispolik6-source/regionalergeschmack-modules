...
const CANDIDATE_POOL = Object.freeze([
    ...
    })),
    {
        ...
        tags: ['soup', 'warm', 'rain', 'cold', 'evening'],
        icon: '🍲',
        isSampleImage: true
    },
    {
        ...
        categoryKey: 'farmers',
        tags: ['strawberries', 'hot', 'summer', 'fruit'],
        icon: '🍓',
        isSampleImage: true
    },
    {
    ...
    },
    {
        ...
        price: 2.5,
        unit: '',
        imageSlug: 'soft-drink',
        categoryKey: 'restaurants',
        tags: ['soft-drink', 'hot', 'drink', 'ice'],
        icon: '🥤',
        isSampleImage: true
    },
    {
        ...
        categoryKey: 'farmers',
        tags: ['vegetables', 'autumn', 'spring', 'fresh'],
        icon: '🥬',
        isSampleImage: true
    },
    {
        ...
        tags: ['pastries', 'morning', 'coffee', 'rain'],
        icon: '🥐',
        isSampleImage: true
    }
]);
